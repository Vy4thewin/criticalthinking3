...
The alternative path consist of utilizing imputation to assign synthetic values. Imputation can take many different forms, but they all accomplish the same goal: to assume a value based on the distribution of the data. For this particular analysis, MICE is used to predict the
...
train.c1<-complete(mice(train.c1,method = "lasso.norm",seed = 333)) #Using MICE
...
### 2.3 Calculating New Predictors
