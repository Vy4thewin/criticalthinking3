...
All three models scored around 70% with model three having a slightly lower score. Nothing of concern is revealed by this metric. Although the score is lower, We will continue to accept model 3 as the top candidate. Again, evaluation metrics such as AIC are considered better for predictive purposes. 
...
**Making Predictions**
The model yielded a 20/20 split. If 
```{r echo=FALSE}
