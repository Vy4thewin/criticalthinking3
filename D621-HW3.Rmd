...
1-pchisq(model_res[["df.residual"]][1],fit1$df.residual) #model1
1-pchisq(model_res[["df.residual"]][2],fit2$df.residual) #model2
1-pchisq(model_res[["df.residual"]][3],fit3$df.residual) #model3
```
